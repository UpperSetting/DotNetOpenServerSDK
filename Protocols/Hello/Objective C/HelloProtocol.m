...
#include "com/us/openserver/protocols/hello/HelloProtocol.h"
...
- (void)logWithComUsOpenserverLevelEnum:(ComUsOpenserverLevelEnum *)level
  ...
  [((ComUsOpenserverSessionSession *) nil_chk(session_)) logWithComUsOpenserverLevelEnum:level withNSString:NSString_formatWithNSString_withNSObjectArray_(@"[Hello] %1$s", [IOSObjectArray newArrayWithObjects:(id[]){ message } count:1 type:NSObject_class_()])];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "PROTOCOL_IDENTIFIER_", NULL, 0x19, "I", NULL, NULL, .constantValue.asInt = ComUsOpenserverProtocolsHelloHelloProtocol_PROTOCOL_IDENTIFIER },
  };
